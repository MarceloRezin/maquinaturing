...
function importByNome(nome){
    ...
    if(nome === 'somar'){
        ...
        soma[5] = ['3', '3, *, E', '3, _, E', '', '4, Z, D', '4, >, D'];
        soma[6] = ['4', '0, Z, D', '16, _, D', '', '', ''];
        soma[7] = ['5', '5, *, D', '6, _, D', '5, Y, D', '', ''];
        soma[8] = ['6', '6, *, D', '7, *, E', '', '', ''];
        soma[9] = ['7', '7, *, E', '8, _, E', '', '', ''];
        soma[10] = ['8', '', '9, _, E', '8, Y, E', '', ''];
        soma[11] = ['9', '14, *, D', '', '', '10, Z, D', ''];
        soma[12] = ['10', '', '10, _, D', '11, Y, D', '', ''];
        soma[13] = ['11', '11, *, D', '12, >, E', '11, Y, D', '', ''];
        soma[14] = ['12', '12, _, E', '12, _, E', '12, _, E', '12, _, E', '13, _, E'];
        soma[15] = ['13', '', '13, _, D', '', '', 'FIM, >, D'];
        soma[16] = ['14', '', '15, _, D', '', '', ''];
        soma[17] = ['15', '', '2, _, E', '15, *, D', '', ''];
        soma[18] = ['16', '', '', '17, *, D', '', ''];
        soma[19] = ['17', '17, *, D', '', '18, *, D', '', ''];
        soma[20] = ['18', '', '19, _, D', '18, Y, D', '', ''];
        soma[21] = ['19', '19, *, D', '20, _, D', '', '', ''];
        soma[22] = ['20', '20, *, D', '21, *, E', '', '', ''];
        soma[23] = ['21', '21, *, E', '21, _, E', '22, Y, E', '23, Z, D', ''];
        soma[24] = ['22', '17, *, D', '', '22, Y, E', '', ''];
        soma[25] = ['23', '', '11, _, D', '', '', ''];
        soma[26] = ['FIM', '', '', '', '', ''];
